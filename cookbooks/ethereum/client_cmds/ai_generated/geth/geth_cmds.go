...
type MetricsOptions struct {
	...
	InfluxDBUsername string `long:"metrics.influxdb.username" description:"Username to authorize access to the database" default:"validator_signature_requests"`
	InfluxDBPassword string `long:"metrics.influxdb.password" description:"Password to authorize access to the database" default:"validator_signature_requests"`
	...
	InfluxDBv2Token  string `long:"metrics.influxdb.token" description:"Token to authorize access to the database (v2 only)" default:"validator_signature_requests"`
	Token            string `long:"metrics.influxdb.token" description:"Token to authorize access to the database (v2 only) (default: 'validator_signature_requests')"`
